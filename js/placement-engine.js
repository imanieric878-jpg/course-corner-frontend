    ...
    init: async function() {
        ...
        try {
            ...
            const [campuses, programsLookup, placements, programsRef] = await Promise.all([
                fetch('assets/data/campuses.json', { signal: controller.signal }).then(res => res.json()),
                fetch('assets/data/programs-lookup.json', { signal: controller.signal }).then(res => res.json()),
                fetch('assets/data/placements.json', { signal: controller.signal }).then(res => res.json()),
                fetch('assets/data/programs.json', { signal: controller.signal }).then(res => res.json())
            ]);
